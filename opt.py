...
class OptInit():
    def __init__(self):
        parser = argparse.ArgumentParser(description='PyTorch implementation of BrainGT')
        ...
        parser.add_argument('--ckpt_path', type=str, default='savePath', help='checkpoint path to save trained models')
